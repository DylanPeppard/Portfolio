        ...
        <div className = "page">
            ...
            <div className = "biography">
                <div>Hi! I'm 26 years old and from San Diego, CA. I'm graduating with my second B.S. in Software Engineering
                    ...
                    out if you need a software engineer for a job, internship, passion project, research project, or just to chat with!<br />
                </div>
                <div>Professionally, I've worked in many different industries. I'm currently a reservist in the U.S. Coast Guard, specializing in
